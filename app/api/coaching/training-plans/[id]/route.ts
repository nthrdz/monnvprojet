...
export async function PUT(
  ...
  try {
    ...
    let finalPdfFileName: string | undefined = plans[planIndex].pdfFileName
    if (pdfFile && pdfFile.name) {
      finalPdfFileName = (pdfFile as File).name
    } else if (incomingPdfFileName !== undefined) {
      finalPdfFileName = incomingPdfFileName
    }
    ...
    const updatedPlan = {
      ...
      ...(finalPdfFileName !== undefined && { pdfFileName: finalPdfFileName })
    }
